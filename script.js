...
// The current portfolio uses the .topbar header. Only attach the legacy
// mobile-navigation handlers when those elements actually exist. This keeps
// the script running so thumbnails/reveal animations are initialized.
if (menuButton && nav) {
